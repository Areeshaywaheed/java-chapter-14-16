...
// ************************************* Question 03 ************************************
// let stringArr = ["Areesha", "Abdul", "Wwaheed"];
...
// ************************************* Question 06 ************************************
// let mixedArr = ["Honey", 6, 7, "Abdul", true, 4, "Wwaheed", true];
...
// ************************************* Question 09 ************************************
// let colors = ["green", "black", "silver", "golden", "purple", "blue", "red"];
// document.write("Array: " + colors + "<br> <br>");

// let userAdd = prompt("Which color do you want to add at the beginning?", "yellow");
// colors.unshift(userAdd);
// document.write("Array after addition of a value at the beginning: " + colors + "<br> <br>");

// let userAddAtEnd = prompt("Which color do you want to add at the end?", "white");
// colors.push(userAddAtEnd);
// document.write("Array after addition of a value at the end: " + colors + "<br> <br>");

// let userAddAgain = prompt("Which color do you want to add at the begininng?", "violet");
// let userAddAgainAgain = prompt("Which color do you want to add at the begininng?", "pink");
...
// let userChoice = prompt("Which color do you want to add?", "grey")
...
// let userChoiceAgain = prompt("Which color do you want to add?", "orange")
